...
public class Teste {
	...
	public static void main(String[] args) {
		...
		Paciente p = new Paciente("Alan Possamai", 123, 123, 'M', date = new Date(1998, 3, 9), 518242, "Av. Osvaldo Aranha", convenio, 95.8, 1.73, true); 
		Funcionario f = new Funcionario("João", 123, 123, 'M', date, 131, 3100, date, true);
		Medico m = new Medico("Angélica", 345, 345, 'F', date = new Date(1971, 9, 4), 512, 5200.90, date = new Date(1996, 12, 23), true, 654342, "Pediatra");
